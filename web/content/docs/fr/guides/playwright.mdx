...
d'InboxTap, avec liens de vérification, liens magiques, connexion OTP, renvoi et processus Playwright
parallèles.
...
Créez la boîte dans le test ou sa configuration, jamais une seule fois au niveau du module pour toute la
suite. Chaque appel génère une nouvelle adresse destinataire, donc les processus Playwright peuvent
